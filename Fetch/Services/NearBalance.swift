...
enum NearBalanceService {
    ...
    static func endpointCatalog() -> [String] { NearProvider.endpointCatalog() }
    static func rpcEndpointCatalog() -> [String] { NearProvider.rpcEndpoints }
    static func diagnosticsChecks() -> [(endpoint: String, probeURL: String)] { NearProvider.diagnosticsChecks() }

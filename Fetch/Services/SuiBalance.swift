...
enum SuiBalanceService {
    ...
    static func endpointCatalog() -> [String] { SuiProvider.endpointCatalog() }
    static func diagnosticsChecks() -> [(endpoint: String, probeURL: String)] { SuiProvider.diagnosticsChecks() }
}

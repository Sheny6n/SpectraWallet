...
struct ReceiveView: View {
    ...
    private var presentation: Presentation {
        ...
        let sameChainSymbolsText =
            selectedCoin.map { coin in
        ...
        return Presentation(
            resolvedAddress: resolvedAddress, canUseAddress: !trimmedAddress.isEmpty,
            qrImage: trimmedAddress.isEmpty ? nil : QRCodeRenderer.makeImage(from: resolvedAddress),
            receiveWallets: store.receiveEnabledWallets, selectedCoin: selectedCoin, sameChainSymbolsText: sameChainSymbolsText
        )
    }
    var body: some View {
        ZStack {

...
SpectraJsonResponse *spectra_core_static_resource_json(const SpectraCoreJSONRequest *request);
SpectraJsonResponse *spectra_core_static_text_resource_utf8(const SpectraCoreJSONRequest *request);
...
SpectraJsonResponse *spectra_core_build_persisted_snapshot_json(const SpectraCoreJSONRequest *request);
SpectraJsonResponse *spectra_core_wallet_secret_index_json(const SpectraCoreJSONRequest *request);
...
SpectraJsonResponse *spectra_core_plan_evm_refresh_targets_json(const SpectraCoreJSONRequest *request);
SpectraJsonResponse *spectra_core_plan_dogecoin_refresh_targets_json(const SpectraCoreJSONRequest *request);
SpectraJsonResponse *spectra_core_plan_wallet_balance_refresh_json(const SpectraCoreJSONRequest *request);
SpectraJsonResponse *spectra_core_plan_transfer_availability_json(const SpectraCoreJSONRequest *request);
SpectraJsonResponse *spectra_core_route_send_asset_json(const SpectraCoreJSONRequest *request);
SpectraJsonResponse *spectra_core_plan_send_preview_routing_json(const SpectraCoreJSONRequest *request);
SpectraJsonResponse *spectra_core_plan_send_submit_preflight_json(const SpectraCoreJSONRequest *request);
SpectraJsonResponse *spectra_core_plan_utxo_preview_json(const SpectraCoreJSONRequest *request);
SpectraJsonResponse *spectra_core_plan_utxo_spend_json(const SpectraCoreJSONRequest *request);

...
extension WalletStore {
    ...
    var dogecoinHistoryDiagnosticsByWallet: [UUID: BitcoinHistoryDiagnostics] {
    ...
    var ethereumHistoryDiagnosticsByWallet: [UUID: EthereumTokenTransferHistoryDiagnostics] {
    ...
    var etcHistoryDiagnosticsByWallet: [UUID: EthereumTokenTransferHistoryDiagnostics] {
    ...
    var arbitrumHistoryDiagnosticsByWallet: [UUID: EthereumTokenTransferHistoryDiagnostics] {
    ...
    var optimismHistoryDiagnosticsByWallet: [UUID: EthereumTokenTransferHistoryDiagnostics] {
    ...
    var bnbHistoryDiagnosticsByWallet: [UUID: EthereumTokenTransferHistoryDiagnostics] {
    ...
    var avalancheHistoryDiagnosticsByWallet: [UUID: EthereumTokenTransferHistoryDiagnostics] {
    ...
    var hyperliquidHistoryDiagnosticsByWallet: [UUID: EthereumTokenTransferHistoryDiagnostics] {
    ...
    var tronHistoryDiagnosticsByWallet: [UUID: TronHistoryDiagnostics] {
    ...
    var solanaHistoryDiagnosticsByWallet: [UUID: SolanaHistoryDiagnostics] {
    ...
    var xrpHistoryDiagnosticsByWallet: [UUID: XRPHistoryDiagnostics] {
    ...
    var stellarHistoryDiagnosticsByWallet: [UUID: StellarHistoryDiagnostics] {
    ...
    var moneroHistoryDiagnosticsByWallet: [UUID: MoneroHistoryDiagnostics] {
    ...
    var suiHistoryDiagnosticsByWallet: [UUID: SuiHistoryDiagnostics] {
    ...
    var aptosHistoryDiagnosticsByWallet: [UUID: AptosHistoryDiagnostics] {
    ...
    var tonHistoryDiagnosticsByWallet: [UUID: TONHistoryDiagnostics] {
    ...
    var icpHistoryDiagnosticsByWallet: [UUID: ICPHistoryDiagnostics] {
    ...
    var nearHistoryDiagnosticsByWallet: [UUID: NearHistoryDiagnostics] {
    ...
    var polkadotHistoryDiagnosticsByWallet: [UUID: PolkadotHistoryDiagnostics] {
    ...
    var cardanoHistoryDiagnosticsByWallet: [UUID: CardanoHistoryDiagnostics] {
    ...
    var bitcoinHistoryDiagnosticsByWallet: [UUID: BitcoinHistoryDiagnostics] {
    ...
    var bitcoinCashHistoryDiagnosticsByWallet: [UUID: BitcoinHistoryDiagnostics] {
    ...
    var bitcoinSVHistoryDiagnosticsByWallet: [UUID: BitcoinHistoryDiagnostics] {
    ...
    var litecoinHistoryDiagnosticsByWallet: [UUID: BitcoinHistoryDiagnostics] {

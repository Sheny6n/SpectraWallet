...
final class WalletRuntimeState: ObservableObject {
    ...
    @Published var appLockError: String? @Published var isPreparingEthereumReplacementContext: Bool = false
    ...
    var pendingSelfSendConfirmation: WalletStore.PendingSelfSendConfirmation? var activeEthereumSendWalletIDs: Set<UUID> = []
    var lastSendDestinationProbeKey: String? var lastSendDestinationProbeWarning: String? var lastSendDestinationProbeInfoMessage: String? var cachedResolvedENSAddresses: [String: String] = [:]
    ...
    var lastLivePriceRefreshAt: Date? var lastFiatRatesRefreshAt: Date? var lastFullRefreshAt: Date? var lastChainBalanceRefreshAt: Date? var lastBackgroundMaintenanceAt: Date? var isNetworkReachable: Bool = true

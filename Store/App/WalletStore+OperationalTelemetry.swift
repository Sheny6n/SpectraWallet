...
extension WalletStore {
    ...
    func appendOperationalLog(_ level: OperationalLogEvent.Level, category: String, message: String, chainName: String? = nil, walletID: UUID? = nil, transactionHash: String? = nil, source: String? = nil, metadata: String? = nil) {
    ...
    func registerPendingSelfSendConfirmation(walletID: UUID, chainName: String, symbol: String, destinationAddress: String, amount: Double) {
    ...
    func consumePendingSelfSendConfirmation(walletID: UUID, chainName: String, symbol: String, destinationAddress: String, amount: Double) -> Bool {
    ...
    private func rustSelfSendConfirmationPlan(walletID: UUID, chainName: String, symbol: String, destinationAddress: String, amount: Double, ownedAddresses: [String]) -> WalletRustSelfSendConfirmationPlan? {
        let request = WalletRustSelfSendConfirmationRequest(
            pendingConfirmation: pendingSelfSendConfirmation.map {
                WalletRustPendingSelfSendConfirmationInput(
                    walletID: $0.walletID.uuidString, chainName: $0.chainName, symbol: $0.symbol, destinationAddressLowercased: $0.destinationAddressLowercased, amount: $0.amount, createdAtUnix: $0.createdAt.timeIntervalSince1970
                )
            }, walletID: walletID.uuidString, chainName: chainName, symbol: symbol, destinationAddress: destinationAddress, amount: amount, nowUnix: Date().timeIntervalSince1970, windowSeconds: Self.selfSendConfirmationWindowSeconds, ownedAddresses: ownedAddresses
        )

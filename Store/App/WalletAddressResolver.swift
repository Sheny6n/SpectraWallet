...
enum WalletAddressResolver {
    ...
    static func resolvedEthereumAddress(for wallet: ImportedWallet, using store: WalletStore) -> String? { resolvedEVMAddress(for: wallet, chainName: "Ethereum", using: store) }
    ...
    static func resolvedAddress(for wallet: ImportedWallet, chainName: String, using store: WalletStore) -> String? {
        switch chainName {

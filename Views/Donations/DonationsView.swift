...
struct DonationsView: View {
    @State private var selectedDonation: DonationDestination? @State private var copiedAddress: String? private var copy: DonationsContentCopy { DonationsContentCopy.current }
    var body: some View {
        NavigationStack {
            ZStack {
                SpectraBackdrop()

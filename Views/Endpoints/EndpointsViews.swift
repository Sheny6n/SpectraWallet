    ...
    private func endpointSection(_ descriptor: AppChainDescriptor) -> some View {
        Section(descriptor.chainName) {
            ...
            case .arbitrum: endpointRows(arbitrumEndpoints)
                readOnlyFootnote
            case .optimism: endpointRows(optimismEndpoints)
                readOnlyFootnote
            case .bnb: endpointRows(bnbEndpoints)
                readOnlyFootnote
            case .avalanche: endpointRows(avalancheEndpoints)
                readOnlyFootnote
            case .hyperliquid: endpointRows(hyperliquidEndpoints)
                readOnlyFootnote

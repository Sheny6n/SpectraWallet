...
struct WalletRustWatchOnlyEntries: Codable {
    ...
    let bitcoinXpub: String? let bitcoinCashAddresses: [String]
...
struct WalletRustSecretObservation: Encodable {
    let walletID: String
    let secretKind: String? let hasSeedPhrase: Bool
...
struct WalletRustActiveMaintenancePlanRequest: Encodable {
    let nowUnix: Double
    let lastPendingTransactionRefreshAtUnix: Double? let lastLivePriceRefreshAtUnix: Double? let hasPendingTransactionMaintenanceWork: Bool
...
struct WalletRustBackgroundMaintenanceRequest: Encodable {
    ...
    let lastBackgroundMaintenanceAtUnix: Double? let interval: Double
}
...
struct WalletRustHistoryTransaction: Encodable {
    let id: String
    let walletID: String? let kind: String
    let status: String
    let walletName: String
    ...
    let chainName: String
    let address: String
    let transactionHash: String? let transactionHistorySource: String? let createdAtUnix: Double
}
...
struct WalletRustBitcoinHistorySnapshotPayload: Codable {
    ...
    let blockHeight: Int? let createdAtUnix: Double
}
...
struct WalletRustTransactionRecord: Codable {
    ...
    let amount: Double
    let address: String
    let transactionHash: String? let ethereumNonce: Int? let receiptBlockNumber: Int? let receiptGasUsed: String? let receiptEffectiveGasPriceGwei: Double? let receiptNetworkFeeETH: Double? let feePriorityRaw: String? let feeRateDescription: String? let confirmationCount: Int? let dogecoinConfirmedNetworkFeeDOGE: Double? let dogecoinConfirmations: Int? let dogecoinFeePriorityRaw: String? let dogecoinEstimatedFeeRateDOGEPerKB: Double? let usedChangeOutput: Bool? let dogecoinUsedChangeOutput: Bool? let sourceDerivationPath: String? let changeDerivationPath: String? let sourceAddress: String? let changeAddress: String? let dogecoinRawTransactionHex: String? let signedTransactionPayload: String? let signedTransactionPayloadFormat: String? let failureReason: String? let transactionHistorySource: String? let createdAtUnix: Double
}
...
struct WalletRustEVMRefreshTargetsRequest: Encodable {
    ...
    let allowedWalletIDs: [String]? let groupByNormalizedAddress: Bool
}
...
struct WalletRustSendSubmitPreflightPlan: Decodable {
    ...
    let previewKind: String? let normalizedDestinationAddress: String
    let amount: Double
    let chainName: String
    let symbol: String
    let nativeEVMSymbol: String? let isNativeEVMAsset: Bool
    let allowsZeroAmount: Bool
}
...
struct WalletRustSelfSendConfirmationRequest: Encodable {
    let pendingConfirmation: WalletRustPendingSelfSendConfirmationInput? let walletID: String
    let chainName: String
    let symbol: String
    let destinationAddress: String
    let amount: Double

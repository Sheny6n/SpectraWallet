...
struct WalletRustDerivationRequestModel {
    ...
    let derivationPath: String? let passphrase: String? let hmacKey: String? let mnemonicWordlist: String? let iterationCount: UInt32
}
...
private struct WalletRustMaterialRequestPayload: Encodable {
    ...
    let seedPhrase: String
    let derivationPath: String
    let passphrase: String? let hmacKey: String? let mnemonicWordlist: String? let iterationCount: UInt32
}
